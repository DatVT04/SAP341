class ZCL_Z_349_PURORDER_MPC definition
  public
...
public section.
  ...
  types:
     TS_PURCHASEORDER type ZST_PO_OUTPUT .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_349_PURORDER_MPC========CP' ##NO_TEXT.
...
CLASS ZCL_Z_349_PURORDER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_349_PURORDER_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZST_PO_OUTPUT'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260317214950'.                  "#EC NOTEXT
